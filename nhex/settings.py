"""
Django settings for nhex project.
...
SECRET_KEY = "django-insecure-%x_ojimk05%^pp0)ad&u&$az^z$^8%(sywh!7*4*_5a=(mpy2l"
...
WSGI_APPLICATION = "nhex.wsgi.application"
...
MiB = 1024 * 1024
MAX_RESOURCE_FILE_SIZE = MiB
MAX_SIZE_OF_SINGLE_UPLOAD = 10 * MiB
